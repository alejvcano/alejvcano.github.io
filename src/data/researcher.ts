...
export const researcherInfo: ResearcherInfo = {
  ...
  biography: `I work at the interface of physics, evolutionary biology and ecology, building mechanistic and phenomenological models of how complex living systems — from evolving genomes to exploited fish populations — unfold in time and respond to perturbations.
