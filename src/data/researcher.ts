...
export const researcherInfo: ResearcherInfo = {
  ...
  heroIntroduction: 'modelling complex natural systems',

  biography: `I work at the interface of physics, ecology and evolutionary biology, building mechanistic and phenomenological models of how complex natural systems — from genomes to individuals, from populations to communities and ecosystems — unfold in time and respond to perturbations.
