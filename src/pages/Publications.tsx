...
const publications: { citation: string; url: string }[] = [
  ...
  { citation: 'A. Cano, A. Couce, J. Masel, J. L. Payne, A. Stoltzfus, J. F. Storz. "Misrepresenting biases in arrival: a comment on Svensson (2022)." EcoEvoRxiv (2022).', url: 'https://doi.org/10.32942/X2SG6V' },
